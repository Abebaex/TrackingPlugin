...
function tracking_install()
{
    ...
    $sql = "CREATE TABLE $table_name (
						  ...
						  ship_receiver varchar(255) DEFAULT NULL, PRIMARY KEY (ship_id)) ";
  ...
  <tbody>
    ...
    <tr style="background-color:#FFFFFF;">
      <th valign="top"><span style="font-size:12pt;"><?php echo esc_attr($item['ship_shipper'])?></span><br />
        ...
        Phone : <?php echo esc_attr($item['ship_shipper_phone'])?> </th>
...
<table cellspacing="2" cellpadding="5" class="form-table">
  <tbody>
    ...
    <tr>
      <th colspan="3"><span style="font-size:14pt;">Shipper Detail</span></th>
    </tr>
    <tr>
    ...
    <tr>
      <th colspan="3"><span style="font-size:14pt;">Consignee Details</span></th>
    </tr>
    <tr>
      <th valign="top">Name</th>
      <td valign="top">:</td>
  ...
  <table cellpadding="10" cellspacing="0" width="100%" class="aqua_table">
    ...
    <tr>
      <td>Please enter Number AWB <br />
        ...
        <textarea id="ship_awbno" name="ship_awbno" style="width: 95%" rows="3"></textarea>
...
<style>
.aqua_table th {text-align: center;}
</style>
<table cellpadding="10" width="100%" cellspacing="0" border="1" bordercolor="#F2F2F2" class="aqua_table">
  <tbody>
    ...
    <?php if ($city){ ?>
    <tr>
      <td colspan="3"><div class="sixteen columns" style="width: 890px;">
          <div id="google_map">
